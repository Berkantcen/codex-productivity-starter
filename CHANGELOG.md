...
- Added Codex-ready workspace documentation.
- Added token efficiency and adoption playbooks.
- Added example task briefs for feature work, bug investigation, and PR review.
